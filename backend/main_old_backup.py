...
from models import CustomChatbot, ChatbotAccess, ChatbotDocument
...
# Contexto de hash de contraseñas usando bcrypt directamente
...
async def chatbot_info():
    ...
    return {
        "mode": "rag_enabled",
        "rag_enabled": True,
        "description": "Chatbot con RAG usando Pinecone, Gemini 2.0 Flash y Sentence Transformers",
